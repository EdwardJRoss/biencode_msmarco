...
def get_train_queries(hard_negatives: Iterable[HardNegative],
                      ce_scores: Dict[QueryId, Dict[int, float]],
...
def get_corpus(data_folder=data_folder,
...
with gzip.open(hard_negatives_filepath, 'rt') as fIn:
    hard_negatives = map(json.loads, tqdm.tqdm(fIn))
    train_queries = get_train_queries(hard_negatives, ce_scores, ce_score_margin, queries, negs_to_use, use_all_queries=args.use_all_queries)
del ce_scores
